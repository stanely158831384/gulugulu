...
type SimplebankClient interface {
	...
	LoginUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreateUserResponse, error)
}
...
func (c *simplebankClient) LoginUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreateUserResponse, error) {
	out := new(CreateUserResponse)
...
type SimplebankServer interface {
	...
	LoginUser(context.Context, *CreateUserRequest) (*CreateUserResponse, error)
...
func (UnimplementedSimplebankServer) LoginUser(context.Context, *CreateUserRequest) (*CreateUserResponse, error) {
...
func _Simplebank_LoginUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimplebankServer).LoginUser(ctx, req.(*CreateUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
